...
Hér eru nokkrir hlutir til að hugleiða í samhengi við lestur greinar Paul Lockhart, \href{https://archive.org/details/AMathematiciansLament}{A Mathematician's Lament}.

\section{Algebra og daglegt líf}\label{algebra-og-daglegt-luxedf}

Á blaðsíðu 8 í \emph{A Mathematician's Lament} eftir Paul Lockhart stendur að algebra snúist ekki um daglegt líf, heldur tölur og samhverfur. Svo setur hann fyrir spurningu sem hann segir einfalda og fallega:

\begin{quote}
Segjum að ég fái gefna summu og mismun tveggja talna. Hvernig finn ég út hverjar tölurnar eru?
\end{quote}

\subsection{Verkefni: Summa og mismunur}\label{verkefni-summa-mismunur}
...
\section{Samhverfur (breytileiki)}\label{samhverfur}
...
\subsection{Hvaða aðgerðir breyta ekki lausnum jafna}\label{samhverfur-jafna}
...
Skoðið textann um stærðfræði í \url{https://www.adalnamskra.is/grunnskoli/kafli-25-staerdfraedi-2024}.

\subsection{Verkefni: Aðalnámskrá út frá Lockhart}\label{verkefni-namskra-lockhart}
...
\subsection{Verkefni: Samanburður kennsluefnis um jöfnur}\label{verkefni-kennsluefni-lockhart}
...
\section{Dæmi Regla Þalesar}\label{lockhart-thales}
...
\subsection{Regla Þalesar með pappír og blýanti (eða í huganum)}\label{thales-pappir}
...
\subsection{Regla Þalesar með kviku rúmfræðiforriti}\label{thales-geogebra}
