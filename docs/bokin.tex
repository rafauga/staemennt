...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{bokin_files/figure-latex/reitir-1.pdf}}
...
\subsection{Verkefni um táknskyn}\label{verkefni-um-tuxe1knskyn}
...
\subsection{Verkefni: Að túlka margföldun og deilingu}\label{verkefni-auxf0-tuxfalka-margfuxf6ldun-og-deilingu}
...
\subsection{Verkefni: Jafngild brot}\label{verkefni-jafngild-brot}
...
\subsection{Verkefni: Hraði á hjóli}\label{verkefni-hrauxf0i-uxe1-hjuxf3li}
...
\section{Að festa í sessi (e. institutionalization)}\label{auxf0-festa-uxed-sessi-e.-institutionalization}
